...
export const Route = createRootRoute({
  head: () => ({
    meta: [
      ...
      { name: "author", content: "Lafia Health" },
      { property: "og:title", content: "Lafia | Nigeria's Unified Health Identity Platform" },
      {
      ...
      {
        name: "twitter:title",
        content: "Lafia | Nigeria's Unified Health Identity Platform",
      },
      {
